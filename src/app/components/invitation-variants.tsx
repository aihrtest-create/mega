...
export default function InvitationVariants() {
  ...
  const initialVariants: CardVariant[] = [
    ...
    },
    {
      ...
      emojiKey: "popper",
      emojiPath: "/images/3d_popper.webp",
      childName: "Вася",
      age: "7 лет",
      date: "15.11.2026",
      time: "15:00",
    ...
    },
    {
      ...
      emojiKey: "balloon",
      emojiPath: "/images/3d_balloon.webp",
      childName: "Миша",
      age: "8 лет",
      date: "05.09.2026",
      time: "16:30",
