...
const CARDS = [
  {
    stepNumber: "01",
    title: "Лис Рокки\nзапускает стрим\nиз мира вокселей",
    subtitle: "и призывает команду спасти игры",
    image: "/quests/voxels/01.webp",
  },
  {
    stepNumber: "02",
    badge: "ТОЛЬКО В HELLO PARK",
    title: "Каждый ребёнок создаёт\nсвоего аватара",
    subtitle: "проводник во вселенные Hello Park и союзник в миссиях",
    image: "/quests/voxels/03.webp",
    borderColor: "#4CAF50",
  },
  {
    stepNumber: "03",
    title: "Победить Глитча\nи его армию багов",
    subtitle: "пройти цифровые испытания и спасти все игры парка",
    image: "/quests/voxels/02.webp",
  },
];

export function SlidePhygitalVoxels() {
  return (
    <div
    ...
    >
      ...
      <div style={{ marginTop: "2%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ fontSize: "clamp(8px, 0.75vw, 12px)", color: "#4CAF50", fontWeight: 700 }}>
